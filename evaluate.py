...
def evaluate_aa(args, model,log_path,aa_batch=128, anchors_knowledge=False, attacks=None):
    assert attacks in [None, 'apgd-t', 'square']
    version = 'standard' if attacks is None else 'custom_'+attacks
    ...
    adversary = AutoAttack(new_model, norm='Linf', eps=epsilon, version=version, log_path=log_path, anchors_knowledge=anchors_knowledge)
