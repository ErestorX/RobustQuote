...
def get_args():
    ...
    parser.add_argument('--drop-rate', type=float, default=1.0)
    ...
    parser.add_argument('--eval-queries', type=int, default=5000)
    parser.add_argument('--data-dir', default=os.environ['HOME']+'/imagenette2/', type=str)
